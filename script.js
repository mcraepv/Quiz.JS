...
var questions = [
  ...
  },
  {
    ...
    a: ["my-variable", "my_variable", "myVariable", "Myvariable"],
    c: "myVariable",
  },
  {
  ...
  },
  {
    ...
    a: ["Google", "Microsoft", "Netscape", "Mozilla"],
    c: "Netscape",
  },
];
...
function initQuestions() {
  ...
  function endScreen() {
    ...
    submitBtn.setAttribute("class", "btn btn-primary ml-1");
    ...
    for (var x = 0; x < scores.length; x++) {
      ...
      tdi.innerHTML = scores[x].initials;
      tRow.appendChild(tdi);
      var tds = document.createElement("td");
      tds.innerHTML = scores[x].score;
    ...
    function resetQuiz() {
      colOne.removeChild(h2El);
      colTwo.removeChild(initialsForm);
      colThree.removeChild(pointsCounter);
      colFour.removeChild(table);
      colOne.appendChild(h1El);
      colTwo.appendChild(pEl);
      colThree.appendChild(beginBtnEl);
    }
